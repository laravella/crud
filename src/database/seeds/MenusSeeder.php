...
class SeedMenus extends CrudSeeder 
{
	...
	public function run()
	{
		...
		DB::table('_db_menu_permissions')->delete();
                ...
                $this->addMenu('divider', '/db/select/users', 'icon-file', $contentId);
...
//                $this->__addMenu('Group Permissions', '/', 'icon-file', $adminId);
                ...
                $this->addMenu('Keys', '/db/select/_db_keys', 'icon-file', $metaDataId);
                ...
                $this->addMenu('Action Views', '/db/select/_db_table_action_views', 'icon-file', $metaDataId);
                $this->addMenu('divider', null, '', $metaDataId);
